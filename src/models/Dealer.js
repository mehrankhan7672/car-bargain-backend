...
const dealerSchema = new mongoose.Schema(
  {
    ...
    // FIX: which language this dealer's text fields were entered in — lets
    // the view/edit pages render Urdu content right-to-left with Urdu
    // labels automatically, instead of guessing from the text itself.
      formLanguage: {
      type: String,
      enum: ['en', 'ur'],
      default: 'en',
